...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    m_WebColors = PropBag.ReadProperty("WebColors", m_def_WebColors)
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("WebColors", m_WebColors, m_def_WebColors)
End Sub
...
Public Property Get WebColors() As Boolean
Attribute WebColors.VB_Description = "Sets or Returns that the dialog shows only web safe colors"
    WebColors = m_WebColors
End Property

Public Property Let WebColors(ByVal New_WebColors As Boolean)
    m_WebColors = New_WebColors
    PropertyChanged "WebColors"
End Property
